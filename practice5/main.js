...
app.get('/users/list', function (req, res) {
    var userList = users.map(function (user) { return ({
        id: user.id,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1.default.post('http://localhost:3000/users', userData)];
            case 1:
                response = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error adding user:', error_1.response.data);
                return [3 /*break*/, 3];
