...
var listPagesFolder = 'list_pages';
...
function saveHtmlContent(url, content) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fileName = "".concat(path.basename(url, '.html'), ".html");
            filePath = path.join(listPagesFolder, fileName);
...
function processUrls(urls) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, urls_1, url, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    response = _a.sent();
                    return [4 /*yield*/, saveHtmlContent(url, response.data)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 5:
